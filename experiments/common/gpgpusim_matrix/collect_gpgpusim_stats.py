...
STAT_PATTERNS = {
    ...
    "paper_mascar_m3diag_enabled": re.compile(r"\bpaper_mascar_m3diag_enabled\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_mem_inst_seen": re.compile(r"\bpaper_mascar_m3diag_mem_inst_seen\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_load_inst_seen": re.compile(r"\bpaper_mascar_m3diag_load_inst_seen\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_mp_mode_seen": re.compile(r"\bpaper_mascar_m3diag_mp_mode_seen\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_owner_valid_seen": re.compile(r"\bpaper_mascar_m3diag_owner_valid_seen\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_nonowner_load_candidate": re.compile(r"\bpaper_mascar_m3diag_nonowner_load_candidate\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_scheduler_allow_nonowner_load": re.compile(r"\bpaper_mascar_m3diag_scheduler_allow_nonowner_load\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_scheduler_block_nonowner_mem": re.compile(r"\bpaper_mascar_m3diag_scheduler_block_nonowner_mem\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_lsu_l1d_access_seen": re.compile(r"\bpaper_mascar_m3diag_lsu_l1d_access_seen\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_l1d_nonowner_load_seen": re.compile(r"\bpaper_mascar_m3diag_l1d_nonowner_load_seen\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_hitonly_probe_called": re.compile(r"\bpaper_mascar_m3diag_hitonly_probe_called\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_hitonly_probe_hit": re.compile(r"\bpaper_mascar_m3diag_hitonly_probe_hit\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_hitonly_probe_nack": re.compile(r"\bpaper_mascar_m3diag_hitonly_probe_nack\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_active_hitonly_access_called": re.compile(r"\bpaper_mascar_m3diag_active_hitonly_access_called\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_active_hitonly_access_hit": re.compile(r"\bpaper_mascar_m3diag_active_hitonly_access_hit\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_active_hitonly_access_nack": re.compile(r"\bpaper_mascar_m3diag_active_hitonly_access_nack\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_config_off": re.compile(r"\bpaper_mascar_m3diag_skip_config_off\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_not_mp": re.compile(r"\bpaper_mascar_m3diag_skip_not_mp\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_no_owner": re.compile(r"\bpaper_mascar_m3diag_skip_no_owner\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_owner_warp": re.compile(r"\bpaper_mascar_m3diag_skip_owner_warp\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_not_load": re.compile(r"\bpaper_mascar_m3diag_skip_not_load\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_not_l1d": re.compile(r"\bpaper_mascar_m3diag_skip_not_l1d\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_nonowner_hitonly_disabled": re.compile(r"\bpaper_mascar_m3diag_skip_nonowner_hitonly_disabled\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_not_ready_or_scoreboard": re.compile(r"\bpaper_mascar_m3diag_skip_not_ready_or_scoreboard\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_skip_m2_blocked_before_lsu": re.compile(r"\bpaper_mascar_m3diag_skip_m2_blocked_before_lsu\s*=\s*([0-9.]+)"),
    "paper_mascar_m3diag_trace_lines_emitted": re.compile(r"\bpaper_mascar_m3diag_trace_lines_emitted\s*=\s*([0-9.]+)"),
