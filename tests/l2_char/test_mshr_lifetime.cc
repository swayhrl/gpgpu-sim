// C6: one new miss plus one production MSHR merge, then a held response drain.
#include <assert.h>
#include <stdio.h>
...
static mem_fetch *make_read(partition_mf_allocator &a, unsigned long long cycle) {
  ...
  return a.alloc(0x0000, GLOBAL_ACC_R, active, bytes, sectors, SECTOR_SIZE,
...
int main(int argc, char **argv) {
  ...
  puts("C6 production MSHR lifetime fixture completed");
  return 0;
}
