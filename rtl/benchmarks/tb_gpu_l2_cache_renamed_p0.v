`timescale 1ns/1ps
module tb_gpu_l2_cache_renamed_p0;
  ...
  integer aw_issue_count;
  reg [TOK_W-1:0] aw_issue0,aw_issue1,aw_issue2;
  ...
  always @(posedge clk) begin
    ...
    if (aw_valid && aw_ready) begin
      if (aw_issue_count==0) aw_issue0 <= aw_id;
      if (aw_issue_count==1) aw_issue1 <= aw_id;
      if (aw_issue_count==2) aw_issue2 <= aw_id;
  ...
  task send_write;
    ...
    begin
      ...
      xbwd_wdata<={16{64'hABCD_0000_0000_0000|id}}; xbwd_wstrb<={LINE_W/8{1'b1}};
  ...
  initial begin
    ...
    aw_issue_count=0; aw_issue0=0;aw_issue1=0;aw_issue2=0;

    repeat(5) @(posedge clk); rst_n=1;

    send_write(8'h11,40'h0000_3300);
    send_write(8'h12,40'h0000_3300);
    send_write(8'h13,40'h0000_3300);

    wait (aw_issue_count==3);
    repeat(5) @(posedge clk);

    if (!(aw_issue0==0 && aw_issue1==1 && aw_issue2==2)) begin
      $display("ERROR order mismatch aw_ids=%0d,%0d,%0d",aw_issue0,aw_issue1,aw_issue2);
      $finish_and_return(1);
    end

    $display("RENAMED_P0_PASS aw_ids=%0d,%0d,%0d",aw_issue0,aw_issue1,aw_issue2);
    $finish;
  end
endmodule
